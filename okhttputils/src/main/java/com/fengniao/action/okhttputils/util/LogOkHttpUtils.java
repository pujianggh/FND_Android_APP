package com.fengniao.action.okhttputils.util;
 ...
 * @Description:
 */
public class LogOkHttpUtils {
    private static final String TAG = "OkHttp";
    private static boolean LOG_ENABLE = false;
    private static boolean LOG_DETAIL_ENABLE = false;
