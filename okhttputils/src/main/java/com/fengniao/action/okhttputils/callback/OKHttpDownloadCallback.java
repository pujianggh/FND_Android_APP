package com.fengniao.action.okhttputils.callback;
...
public class OKHttpDownloadCallback implements Callback {
    ...
    public OKHttpDownloadCallback(DownloadResponseHandler downloadResponseHandler, String filePath, Long completeBytes) {
            ...
            if (response.isSuccessful()) {
                ...
                try {
                    ...
                    if(call.isCanceled()) {     //判断是主动取消还是别动出错
                        ...
                        LogOkHttpUtils.e("onResponse saveFile fail", e);
                        mHandler.post(new Runnable() {
                            @Override
                            public void run() {
                                if(mDownloadResponseHandler != null) {
