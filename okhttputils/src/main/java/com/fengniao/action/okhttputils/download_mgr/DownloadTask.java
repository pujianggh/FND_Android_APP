...
public class DownloadTask {
    ...
    public com.fengniao.action.okhttputils.OkHttpCall getMyOkHttp() {
        return mOkHttpCall;
    }

    public void setMyOkHttp(com.fengniao.action.okhttputils.OkHttpCall okHttpCall) {
